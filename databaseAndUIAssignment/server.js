...
app.post('/insert',function(req,res){
    var context = {};
    pool.query("INSERT INTO workoutTable (name, reps, weight, date, units) VALUES (?, ?, ?, ?, ?)", [req.query.name, req.query.reps, req.query.weight, req.query.date, req.query.unts], function(err, result){
      if(err){
        console.log(err);
        return;
      }
